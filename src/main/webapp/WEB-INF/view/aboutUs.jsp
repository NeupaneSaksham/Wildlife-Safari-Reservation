...
<!-- Hero Banner Section -->
<div class="hero-banner" style="background-image: url('https://happymountainnepal.com/wp-content/uploads/2025/03/chitwan-national-park-jeep-safari.jpg');
...
<section class="animals">
    ...
    <div class="animal-cards">
        <div class="animal-card">
            <img src="${pageContext.request.contextPath}/assets/tigers.png" alt="Tiger">
            <div class="info">
                <h3>Tiger</h3>
        ...
        <div class="animal-card">
            <img src="${pageContext.request.contextPath}/assets/elephant.jpg" alt="Elephant">
            <div class="info">
                <h3>Elephant</h3>
        ...
        <div class="animal-card">
            <img src="${pageContext.request.contextPath}/assets/gharial.png" alt="Gharial">
            <div class="info">
                <h3>Gharial</h3>
        ...
        <div class="animal-card">
            <img src="${pageContext.request.contextPath}/assets/rhino.jpg" alt="Rhinoceros">
            <div class="info">
                <h3>Rhinoceros</h3>
        ...
        <div class="animal-card">
            <img src="${pageContext.request.contextPath}/assets/black-stork.png" alt="Black Stork">
            <div class="info">
                <h3>Black Stork</h3>
        ...
        <div class="animal-card">
            <img src="${pageContext.request.contextPath}/assets/swamp-deer.png" alt="Swamp Deer">
            <div class="info">
                <h3>Swamp Deer</h3>
        ...
        <div class="animal-card">
            <img src="${pageContext.request.contextPath}/assets/himalayan-tahr.png" alt="Himalayan Tahr">
            <div class="info">
        ...
        <div class="animal-card">
            <img src="${pageContext.request.contextPath}/assets/red-panda.png" alt="Red Panda">
            <div class="info">
                <h3>Red Panda</h3>
...
<section class="animals">
    ...
    <div class="animal-cards">
        <div class="animal-card">
            <img src="${pageContext.request.contextPath}/assets/img.png" alt="Chitwan National Park">
            <div class="info">
        ...
        <div class="animal-card">
            <img src="${pageContext.request.contextPath}/assets/bardia.png" alt="Bardia National Park">
            <div class="info">
        ...
        <div class="animal-card">
            <img src="${pageContext.request.contextPath}/assets/koshitappu.png" alt="Koshi Tappu Wildlife Reserve">
            <div class="info">
        ...
        <div class="animal-card">
            <img src="${pageContext.request.contextPath}/assets/suklapanta.png" alt="Shuklaphanta Wildlife Reserve">
            <div class="info">
        ...
        <div class="animal-card">
            <img src="${pageContext.request.contextPath}/assets/image.png" alt="Dhorpatan Hunting Reserve">
            <div class="info">
        ...
        <div class="animal-card">
            <img src="${pageContext.request.contextPath}/assets/annapurna.jpg" alt="Annapurna Conservation Area">
            <div class="info">
